...
struct Game {
    map: Map,
    #[serde(default, with = "message_log")]
...
mod message_log {
    ...
    pub fn deserialize<'de, D>(deserializer: D) -> Result<Vec<(String, tcod::Color)>, D::Error>
    where
        D: Deserializer<'de>,
    {
        deserializer.deserialize_u32(I32Visitor)?;
        Ok(Vec::new())
    }
}
